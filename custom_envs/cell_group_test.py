...
def main():
    ...
    LV_params_patient_1 = {  # patient #1 ESS params (index 7): 6060.60606060606,7575.75757575758,1.e-09,27272.7272727273
        'init_counts': np.array([6060.60606060606, 7575.75757575758, 1.e-09], dtype=np.float64),  # T+, TP, T- (scaled to 10% as in paper)
        ...
        'init_psa': np.array([27272.7272727273], dtype=np.float64),
